...
export const updateUserInCognito = async ({ currentUsername, newUsername, email, password, is_active }) => {
    try {
        ...
        if (password) {
            updatePasswordInCognito({ username: currentUsername, newPassword: password });
        }

        // Enable or disable user based on is_active
        if (typeof is_active === 'boolean') {
            await enableOrDisableUserInCognito({ username: currentUsername, is_active });
        }
